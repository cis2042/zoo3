...
function je(e10, o7) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
          return t2 = e10.split("."), i6 = __read(t2, 3), a10 = i6[0], c14 = i6[1], s12 = i6[2], l13 = JSON.parse(u2.decode(a10)), f14 = JSON.parse(u2.decodeUnicode(c14)), p13 = l3(u2.decode(s12)), v7 = l3("".concat(a10, ".").concat(c14)), [4, Pe()];
        case 1:
...
function Qe(e10) {
  var n6, o7;
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a10, c14, l13, f14, d8, h6, v7, g10, b8, C7, F4, I8, y6, _5, B3;
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
        ...
        case 6:
          if (b8 = r10.sent(), C7 = b8.client_id, F4 = b8.expires_in, I8 = m2(e10.liffId), C7 !== I8) throw _3(), w(I, "Failed to verify access_token");
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        ...
        case 1:
          ...
          if (!(s12 = He(c14))) throw w(I, "Invalid context token.");
          return [2, s12];
      }
    });
  });
